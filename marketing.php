       ...
       <p class="forpra left  mt-2 grays">A combination of the best of traditional distribution with the most ground-breaking in digital & Internet distribution in a fusion distribution model:</p>
          ...
          <div class="container">
             <div class="row">
              ...
              <li>Distribution strategy will be created for the optimum monetization of your content.</li>
              <li>PR and marketing materials will be created.</li>
              ...
              <li>Consulting on marketing strategy, including viral marketing and festival strategy</li>
              <li>Production and Creative Development</li>
              <li>House of Film evaluates projects for their commercial viability. In addition, we facilitate the creative process with screenplay, cast and project evaluation</li>
              <li>Consultation on production & marketing elements to facilitate sales</li>
