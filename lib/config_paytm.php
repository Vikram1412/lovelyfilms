...
define('PAYTM_MERCHANT_KEY', '0H_rPZOAj03qIGon'); //Change this constant's value with Merchant key downloaded from portal
define('PAYTM_MERCHANT_MID', 'WBSETC97777242199086'); //Change this constant's value with MID (Merchant ID) received from Paytm
define('PAYTM_MERCHANT_WEBSITE', 'LovelyFilms'); //Change this constant's value with Website name received from Paytm
