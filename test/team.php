    ...
    <div class="container">
      ...
      <div class="full mt-5">
        <div class="full mb-5" style="border:solid 1px #b2b2b2;">
          <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 col-12 float-left text-center forimg" style="margin-top: 0px; padding:0px 0px 0px 0px;"><img src="images/arunk.jpg" alt="" title="" style="height1: 176px;"></div>
        ...
        <div class="full mb-5" style="border:solid 1px #b2b2b2;">
          <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 col-12 float-left text-center forimg " style="margin-top: 0px; padding:0px 0px 0px 0px;"><img src="images/Navneet.jpeg" alt="" title="" style="height1: 176px;"></div>
          <div class="col-xl-10 col-lg-8 col-md-6 col-sm-12 col-12 float-left mt-4 ml-3" style="margin-top: 0.5rem!important;margin-left: 0rem!important;">
            <h4>Mr. Navneet Maheshwari (Mentor)</h4>
        ...
        <div class="full mb-5" style="border:solid 1px #b2b2b2;">
          <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 col-12 float-left text-center forimg " style="margin-top: 0px; padding:0px 0px 0px 0px;"><img src="images/santosh.png" alt="" title="" style="height1: 176px;"></div>
          <div class="col-xl-10 col-lg-8 col-md-6 col-sm-12 col-12 float-left mt-4 ml-3" style="margin-top: 0.5rem!important;margin-left: 0rem!important;">
        ...
        <div class="full mb-5" style="border:solid 1px #b2b2b2;">
          <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 col-12 float-left text-center forimg " style="margin-top: 0px; padding:0px 0px 0px 0px;"><img src="images/sunder.png" alt="" title="" style="height1: 176px;"></div>
          <div class="col-xl-10 col-lg-8 col-md-6 col-sm-12 col-12 float-left mt-4 ml-3" style="margin-top: 0.5rem!important;margin-left: 0rem!important;">
            <h4>Mr. Sundra Raj (Creative Director)</h4>
            <p>Mr. Raj is a NSIT alumnus from Delhi University currently working with Social Issues of Government of India. He is play vital role in Creative Content Making and Direction of Films.</p>
          </div>
        </div>
        ...
        <div class="full mb-5" style="border:solid 1px #b2b2b2;">
          <div class="col-xl-2 col-lg-4 col-md-6 col-sm-12 col-12 float-left text-center forimg " style="margin-top: 0px; padding:0px 0px 0px 0px;"><img src="images/Mahendra.jpeg" alt="" title="" style="height1: 176px;"></div>
          <div class="col-xl-10 col-lg-8 col-md-6 col-sm-12 col-12 float-left mt-4 ml-3" style="margin-top: 0.5rem!important;margin-left: 0rem!important;">
